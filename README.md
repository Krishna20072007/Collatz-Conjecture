This is a repository of my work on the famous Collatz Conjecture.
...
Mathematicians have extensively tested the conjecture using computers, and it holds true for an enormous range of numbers. However, due to the exponential growth of the sequence, it becomes increasingly difficult to prove that it holds for all numbers.
